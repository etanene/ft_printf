...
/*   Updated: 2019/01/07 14:45:15 by afalmer-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int     main(void)
{
	...
	printf("\nFLAGS\n");
	len = printf("original: %ld world %d hello %lld\n", ld, d, lld);
	printf("len: %d\n", len);
	len = ft_printf("customft: %ld world %d hello %lld\n", ld, d, lld);
	printf("len: %d\n\n", len);
	len = printf("original: % d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: % d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: % d hello\n", -d);
	printf("len: %d\n", len);
	len = ft_printf("customft: % d hello\n", -d);
	...
	printf("\nWIDTH\n");
	len = printf("original: %10d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %10d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: % 10d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: % 10d hello\n", d);
	...
	len = ft_printf("customft: %+10d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %010d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %010d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %-10d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %-10d hello\n", d);
	...
	len = ft_printf("customft: %- 010d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %0010d hello\n", -d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %0010d hello\n", -d);
	printf("len: %d\n\n", len);
	...
	len = ft_printf("customft: %.d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %.5d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %.5d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %0.5d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %0.5d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %-.5d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %-.5d hello\n", d);
	...
	len = ft_printf("customft: % .5d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %10.5d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %10.5d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %5.10d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %5.10d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %+5.10d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %+5.10d hello\n", d);
	...
	len = ft_printf("customft: %5.10d hello\n", -d);
	printf("len: %d\n\n", len);
	len = printf("original: %010.5d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %010.5d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %05.10d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %05.10d hello\n", d);
	printf("len: %d\n\n", len);
	len = printf("original: %-010.5d hello\n", d);
	printf("len: %d\n", len);
	len = ft_printf("customft: %-010.5d hello\n", d);
